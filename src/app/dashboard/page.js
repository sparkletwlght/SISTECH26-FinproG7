    ...
    >
        ...
        <div className="mt-2">
          <Link href="/map" className="block group">
            <div className="flex items-center space-x-2 mb-2 w-fit">
              <span className="font-semibold text-gray-800 text-sm group-hover:text-purple-600 transition-colors">
                Map
              </span>
      ...
      <div className="absolute bottom-4 left-0 right-0 px-4 z-10">
        <div className="bg-white/90 backdrop-blur-md rounded-full p-2 border border-purple-100 flex items-center justify-around shadow-md">
          <Link
            href="/dashboard"
            className="flex flex-col items-center bg-purple-100 text-purple-900 px-4 py-1.5 rounded-full"
          >
          ...
          <Link
            href="/map"
            className="flex flex-col items-center text-gray-500 hover:text-purple-600 px-3 py-1.5 transition-colors"
          >
