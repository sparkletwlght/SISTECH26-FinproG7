...
import ReportItem from "@/components/ReportItem"; // Sesuaikan jalur import jika berbeda
    ...
    async function fetchReports() {
      try {
        const { data, error } = await supabase
          ...
          .limit(3); // Ambil 3 laporan terbaru untuk sneak peak dashboard
  ...
  return (
    <MapBackground variant="dashboard">
      ...
      <div className="pt-[460px] px-6 md:px-12 max-w-[1400px] mx-auto flex flex-col relative">
        ...
        {/* ================= BAGIAN ATAS (Popup On-going Route) ================= */}
